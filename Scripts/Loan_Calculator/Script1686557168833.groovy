...
Mobile.tap(findTestObject('Object Repository/Loan_Calculator/android.view.View'), 0)
...
Mobile.tap(findTestObject('Object Repository/Loan_Calculator/android.widget.TextView - Calculate Now'), 0)

Mobile.setText(findTestObject('Object Repository/Loan_Calculator/android.widget.EditText - Enter Loan Amount'), '100000', 
    0)

Mobile.tap(findTestObject('Object Repository/Loan_Calculator/android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/Loan_Calculator/android.view.View (1)'), 0)
